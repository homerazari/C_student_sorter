/* 
Program that grabs from a file, sorts the records, and places student records into a linked list then writes that out to a new file.            
 */
